...
the middle of the second addx -1, so the value of register X is the starting value, 1, plus all of the other addx 
...
if __name__ == '__main__':
	...
	while c < check_cycles[-1]:
		if c+1 in check_cycles:
			signal_total += (c+1) * signal_x
