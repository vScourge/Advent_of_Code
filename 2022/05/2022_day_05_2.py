...
to be ready to unload the final supplies. After the rearrangement procedure completes, what crate ends up on top of 
each stack?
"""
...
if __name__ == '__main__':
	...
	for step in procedure:
		stack1, stack2, num_crates = step
		temp_stack = collections.deque()
		
		for i in range(num_crates):
			temp_stack.append(stacks[stack1-1].pop())
		temp_stack.reverse()
		
		stacks[stack2-1] += temp_stack
