...
the Elves assure you that the grove has plenty of fruit, you decide to grab any fruit you see along the way, just 
in case.
...
calories.sort()
print('total top 3 calories =', sum(calories[-3:]))
