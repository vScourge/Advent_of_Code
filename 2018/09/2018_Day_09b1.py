...
if __name__ == "__main__":
	...
	while True:
		...
		if marble % 23 == 0:
			...
			#circle = circle[ :cur_marble_idx ] + circle[ cur_marble_idx + 1: ]
			...
			if len( circle ) == 1:
				...
				circle = numpy.append( circle, marble )
				...
				#circle[ insert_idx:insert_idx ] = [ marble ]
