...
Santa is trying to deliver presents in a large apartment building, but he can't find the right floor - the directions he got
are a little confusing. He starts on the ground floor (floor 0) and then follows the instructions one character at a time.
...
if __name__ == "__main__":
	...
	directions = open( 'input.txt', 'r' ).read( ).strip( )
	pos = 1
	floor = 0
	...
	print( 'basement pos = {0}'.format( pos ) )
