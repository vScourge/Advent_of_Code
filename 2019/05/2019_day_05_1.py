...
from the expected value, where 0 means the test was successful. Non-zero outputs mean that a function is not working
...
if __name__ == "__main__":
	vals = [ int( n ) for n in open( 'input.txt', 'r' ).read( ).split( ',' ) ]
	codes = { }
	idx = 0
