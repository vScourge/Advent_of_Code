...
if __name__ == "__main__":
	...
	s_pos = Pos( 0, 0 )		# ship pos
	w_pos = Pos( 10, -1 )	# waypoint pos
	...
	for instr in instructions:
		...
		if direction == 'N':
			...
			w_pos.rotate( direction, distance )
			
		if direction == 'F':
			s_pos.x += w_pos.x * distance
			s_pos.y += w_pos.y * distance
			
		print( '{0}, {1}, {2}'.format( instr, s_pos, w_pos ) )
			
	distance = abs( s_pos.x + s_pos.y )
