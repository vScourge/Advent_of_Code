...
def populate_seats( ):
	"""
	Return dict - Key is seat ID (row * 8 + column), value is Node instance
	"""
	root = Node( None, None )
	
	root.front = Node( None, None )
	root.back = Node( None, None )
...
if __name__ == "__main__":
	# Populate tree, 128 rows, 8 seats per row.
