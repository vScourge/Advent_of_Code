...
canonical dangerous ingredient list. (There should not be any spaces in your canonical dangerous ingredient 
...
if __name__ == "__main__":
	...
	# Make list of dangerous ingredients, alphabetized by their allergen
	final_a = { }
	
	for ingredient, allergen in final_i.items( ):
		final_a[ allergen ] = ingredient
		
	dangerous_ingredients = [ final_a[ a ] for a in sorted( list( final_a.keys( ) ) ) ]
	
	answer2 = ','.join( dangerous_ingredients )
