...
if __name__ == "__main__":
	...
	all_adapters = [ int( l ) for l in lines ]
	all_adapters.sort( )
	...
	while True:
		adapter = [ a for a in all_adapters if a - cur_jolts <= 3 ][ 0 ]
	...
	# Find differences
	# Add power adapter, 3 higher than highest rated adapter
