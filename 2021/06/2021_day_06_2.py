...
Realizing what you're trying to do, the submarine automatically produces a list of the ages of several hundred nearby lanternfish (your puzzle input). For example, 
...
def parse_input( ):
	...
	# Key is number of days left, value is number of fish
	data = { }
	
	for day_num in range( 9 ):
		data[ day_num ] = 0
...
while day <= 256:
	print( 'day {0} = {1}'.format( day, data ) )

	zero_count = data[ 0 ]
	
	for day_num in range( 1, 9 ):
		data[ day_num - 1 ] = data[ day_num ]
