...
any environmental instabilities you find to someone so the oasis can be around for the next sandstorm-worn traveler.
...
instead add a zero to the beginning of your sequence of zeroes, then fill in new first values for each 
previous sequence.
...
if __name__ == '__main__':
	...
	for h in range(len(histories)):
		...
		for r in range(len(history)-2, -1, -1):
			row = history[r]
